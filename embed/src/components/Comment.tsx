...
export default function Comment({
    ...
    // Show parent link when beyond max depth (use actual depth from API)
    const showParentLink = comment.depth > config.max_depth;
    ...
    return (
        <>
                ...
                <div className="bulla-comment-header">
                    ...
                    <div className="bulla-comment-meta">
                        ...
                        <span className="bulla-date">
                            ...
                            {comment.parent_author && showParentLink && (
                                <>
                                    {' · '}
                                    <button
                                        type="button"
            ...
            {/* Render replies as siblings when at max depth */}
            {comment.replies.length > 0 &&
                visualDepth >= config.max_depth &&
                comment.replies.map((reply) => (
                    <Comment
